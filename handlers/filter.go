...
// 	if searchValue == "" {
// 		http.Error(w, "search_value field is required", http.StatusBadRequest)
// 		return
// 	}
...
// 	os.MkdirAll("filtered", os.ModePerm)
...
// 	// Reopen for reading and filtering
...
// 		http.Error(w, "Error writing header to filtered CSV: "+err.Error(), http.StatusInternalServerError)
// 		return
// 	}
...
// 			if strings.Contains(strings.ToLower(field), strings.ToLower(searchValue)) {
// 				if err := writer.Write(record); err != nil {
// 					fmt.Println("Error writing matched record:", err)
// 				}
// 				matches++
// 				break
// 			}
...
//		if matches == 0 {
//			fmt.Fprintf(w, "No matching records found for: %s\n", searchValue)
//		} else {
//			w.Header().Set("Content-Type", "text/plain")
//			fmt.Fprintf(w, "Filtered file created: /download/%s\n", "filtered_"+handler.Filename)
//		}
//	}
package handlers
